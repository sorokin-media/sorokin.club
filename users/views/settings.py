...
def edit_payments(request, user_slug):
    ...
    if user.unitpay_id:
        ...
        if plan_query:
            ...
            if request.me.email == 'petrblagov@gmail.com' or request.me.email == 'rupronin@gmail.com' or request.me.email == 'lisabet@gmail.com' or request.me.email == 'info.tikhonov@gmail.com' or request.me.email == 'raskrutka89@gmail.com':
