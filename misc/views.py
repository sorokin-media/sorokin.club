...
def stats_gode(request):
    # '2022-08-01 00:00:00' and '2022-09-04 23:59:59'
    payment_first = []
    dt = DT.datetime.strptime('2022-08-01 00:00:00', '%Y-%m-%d %H:%M:%S')
    datetime_for = dt.timestamp()
    dt = DT.datetime.strptime('2022-09-04 23:59:59', '%Y-%m-%d %H:%M:%S')
