...
ALLOWED_HOSTS = ["*", "127.0.0.1", "localhost", "0.0.0.0", "sorokin.club"]
...
LAYOUT_TITLE = "Сорокин.Клуб 🤘✖️👩‍💻"

LANDING_DESCRIPTION = "Деловое закрытое сообщество предпринимателей — Сорокин.Клуб: это бизнес клуб как молодых и начинающих, так и для директоров и профессионалов своего дела."
LANDING_KEYWORDS = "бизнес клуб, клуб предпринимателей, бизнес сообщество, сообщество предпринимателей, клуб бизнесменов, клуб молодых предпринимателей"
...
OG_MACHINE_AUTHOR_LOGO = "https://sorokin.club/static/images/the_machine_logo.png"
OG_IMAGE_GENERATOR_DEFAULTS = {
    "logo": "https://sorokin.club/static/images/logo/logo-white-text.png",
    "op": 0.6,
    "bg": "#FFFFFF",
}
...
TELEGRAM_CLUB_MONEY_GROUP = os.getenv("TELEGRAM_CLUB_MONEY_GROUP") or "-1002061389524"
...
DEFAULT_AVATAR = "https://sorokin.club/static/images/default_avatar.svg"
...
CLEARED_POST_TEXT = "```\n" \
    ...
    "Если вы хотите приютить и развить эту тему как новый автор, напишите модераторам Клуба: moderator@sorokin.club." \
    "\n```"
...
MESSAGE_QUEUE_DATETIME = datetime(year=2023, month=6, day=30)
...
TG_DEVELOPER_DMITRY = os.getenv("TG_DEVELOPER_DMITRY") or '442442997'
TG_NUTA = os.getenv("TG_NUTA")
TG_BUDDY_GROUP = os.getenv("TG_BUDDY_GROUP")


AFFILATE_LINK_1 = f'{APP_HOST}'
AFFILATE_LINK_2 = f'{APP_HOST}/docs/about'
AFFILATE_LINK_3 = f'{APP_HOST}/open'
AFFILATE_LINK_4 = f'{APP_HOST}/post/1406/'