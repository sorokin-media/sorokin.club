...
def user_to_json(user: User) -> dict:
    return {
        ...
        "daily_email_digest": user.daily_email_digest,
        "weekly_email_digest": user.weekly_email_digest,
        "tg_yesterday_best_posts": user.tg_yesterday_best_posts,
        "tg_weekly_best_posts": user.tg_weekly_best_posts,
